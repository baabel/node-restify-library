  ...
  */
  ...
  _createClass(RestServer, [{
    ...
    */
    ...
    value: function get(url, callback) {
      ...
      this.server.get(url, function (req, res, next) {
        callback(Object.assign(req.params, req.query), function (apiResponse) {
          _this3._processResult(res, apiResponse);
          return next();
        });
      });
    }
    ...
    */
    ...
    value: function post(url, callback) {
      ...
      this.server.post(url, function (req, res, next) {
        callback(req.body, function (apiResponse) {
          _this4._processResult(res, apiResponse);
          return next();
        });
      });
    }
    ...
    */
    ...
    value: function put(url, callback) {
      ...
      this.server.put(url, function (req, res, next) {
        callback(req.body, function (apiResponse) {
          _this5._processResult(res, apiResponse);
          return next();
        });
      });
    }
    ...
    */
    ...
    value: function del(url, callback) {
      ...
      this.server.del(url, function (req, res, next) {
        callback(req.body, function (apiResponse) {
          _this6._processResult(res, apiResponse);
          return next();
        });
      });
    }
    ...
    */
    ...
    key: '_processResult',
    value: function _processResult(httpRes, apiResponse) {
